            ...
            <div className="rightbox">
              <nav className="header-menu">
                <ul className="menu-wrapper">
                  ...
                  <li><Link href="#">Estimate My Property</Link></li>
                  <li className="menu-item-has-children">
                    <Link href="#">More</Link>
                    <ul className="sub-menu">
                      <li><Link href="#">Link 01</Link></li>
                      <li><Link href="#">Link 02</Link></li>
                      <li><Link href="#">Link 03</Link></li>
                      <li><Link href="#">Link 04</Link></li>
                    </ul>
                  </li>
              ...
              <div className="header-actions">
                ...
                <Link className="header-action butn butn-primary-filled has-icon" href="#">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 14 16" fill="none">
                      <path d="M8.03704 9H5.96296C2.67556 9 0 11.2575 0 14.0312V15.3438C0 15.7069 0.347407 16 0.777778 16H13.2222C13.6526 16 14 15.7069 14 15.3438V14.0312C14 11.2575 11.3244 9 8.03704 9ZM12.4444 14.6875H1.55556V14.0312C1.55556 11.9794 3.53111 10.3125 5.96296 10.3125H8.03704C10.4689 10.3125 12.4444 11.9794 12.4444 14.0312V14.6875Z" fill="white" />
                      <path d="M7 8C9.20571 8 11 6.20571 11 4C11 1.79429 9.20571 0 7 0C4.79429 0 3 1.79429 3 4C3 6.20571 4.79429 8 7 8ZM7 1.14286C8.57714 1.14286 9.85714 2.42286 9.85714 4C9.85714 5.57714 8.57714 6.85714 7 6.85714C5.42286 6.85714 4.14286 5.57714 4.14286 4C4.14286 2.42286 5.42286 1.14286 7 1.14286Z" fill="white" />
                    </svg>
                    log in
                  </span>
                </Link>
                ...
                <div className="mobile-navbar-btn">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 26 22" fill="none">
                    <rect y="0.608688" width="26" height="1.69565" fill="#101E33"></rect>
                    <rect y="10.2174" width="17.5217" height="1.69565" fill="#101E33"></rect>
                    <rect y="19.826" width="26" height="1.69565" fill="#101E33"></rect>
                  </svg>
                </div>
              </div>
            </div>
        ...
        <div className="mobile-navbar">
          ...
          <ul className="header-nav list-unstyled m-0 p-0">
            ...
            <li className="menu-item-has-children">
              <Link href="#">More</Link>
              <ul className="sub-menu">
                <li><Link href="#">Facility 01</Link></li>
                <li><Link href="#">Facility 02</Link></li>
                <li><Link href="#">Facility 03</Link></li>
                <li><Link href="#">Facility 04</Link></li>
              </ul>
            </li>
            <li><Link href="#">Contact</Link></li>
          </ul>
