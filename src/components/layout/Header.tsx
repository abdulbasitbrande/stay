...
export default function Header() {
  return (
    <nav className="navbar navbar-expand-lg bg-white border-bottom header-custom">
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          {/* Center Menu */}
          <ul className="navbar-nav mx-auto flex-lg-row flex-column text-uppercase small text-center">
          ...
          {/* Right Side */}
          <div className="d-flex flex-lg-row flex-column align-items-center gap-2 mt-3 mt-lg-0">
            <button className="theme-btn">Book With Us</button>
