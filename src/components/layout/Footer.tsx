      ...
      <div className="container">
        ...
        <div className="footer-bottom">
          <div className="copyright-text fb-col">
            <p className="fw-medium mb-0 text-uppercase">ALL RIGHTS RESERVED - Stay 2025</p>
          </div>
